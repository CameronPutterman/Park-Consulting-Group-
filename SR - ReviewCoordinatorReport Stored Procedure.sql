...
/****** Object:  StoredProcedure [dbo].[rpt_CoT_PM_SR_ReviewCoordinatorReport]    Script Date: 8/18/2025 11:24:03 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT X.DEPARTMENT, X.ASSIGNEDTO, X.DUEDATE, X.RECORDNUMBER, X.PROJECTNAME, X.TASKTYPE, X.AL1
	...
	, DATEDIFF(DAY,X.CREATEDON,COALESCE(X.COMPLETEDDATE,@TODAY)) DAYSOPEN
	, @SHOWLOGO SHOWLOGO
	, @Municipality_Name Municipality_Name
	, @Municipality_Page_Footer Municipality_Page_Footer
FROM (
	/* FILES TASK PLAN */
