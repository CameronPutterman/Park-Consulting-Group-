...
/****** Object:  StoredProcedure [dbo].[rpt_PL_EntitlementsClosureLetter]    Script Date: 8/12/2025 7:16:02 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT P.PLPLANID
	...
	, REPLACE(STUFF((SELECT ', ' + PI_ZoningCategories.SVALUE
		...
		WHERE X.OBJECTID = @PLPLANID
			AND C.SFIELDNAME IN ( 'COLPCK_ZoningCategories' )
